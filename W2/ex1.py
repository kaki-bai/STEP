...
class Item:
    ...
    # |prev|: The previous item in the linked list. If this is the first item 
    #         in the linked list, |prev| is None.
...
class HashTable:
    ...
    def put(self, key, value):
        ...
        # Check if rehash(expand) is needed
    ...
    def delete(self, key):
        ...
        while item:
            if item.key == key:
                ...
                # Check if rehash(shrink) is needed
    ...
    #
    # |expand|: True if expanding, False if shrinking
    def rehash(self, expand):
        # Expand to a Prime number that is about twice its size
        if expand:
            new_bucket_size = self.next_prime(self.bucket_size * 2)
        # Shrink to a Prime number that is about half its size
        else:
            new_bucket_size = self.next_prime(self.bucket_size // 2)
        ...
        for bucket in self.buckets:
            ...
            while item:
                ...
                item = next_item
        # Rehash all existing buckets
        self.buckets = new_buckets
        self.bucket_size = new_bucket_size
    
    # Find the Prime next to n
